  ...
  <div class="flex justify-center items-center w-1/4 min-w-72 h-2/3 bg-[white]">
    <div class="flex flex-col gap-6 justify-center items-center">
        ...
        <label for="fileInput" class="relative cursor-pointer">
            ...
            <div v-if="imagePreviewUrl" @click="toggleFullScaleImage()" class="preview">
            ...
            <input ref="fileInput" id="fileInput" type="file" @input="pickFile" class="absolute w-[32px] h-[32px] opacity-0 pointer-events-none">
<!--            <input v-if="imagePreviewUrl" ref="fileInput" id="fileInput" type="file" @input="pickFile" class="absolute inset-0 w-full h-full opacity-0 pointer-events-none">-->
