...
<template>
    <div
        class="flex justify-center items-center w-1/4 min-w-72 h-2/3 bg-[white]"
    >
        <div class="flex flex-col gap-6 justify-center items-center">
            ...
            <label for="fileInput" class="relative cursor-pointer">
                ...
                <div v-if="imagePreviewUrl" class="preview">
                    <img
                        :src="imagePreviewUrl"
                        alt="Image Preview"
                        class="absolute rounded-full object-cover w-[100px] h-[100px]"
                    />
                </div>
                ...
                <!-- open button -->
                <button
                    @click="toggleFullScaleImage()"
                    class="absolute left-24 top-9 w-[32px] h-[32px]"
                >
                    <svg viewBox="-4.2 -4.2 29.40 29.40" fill="#000000">
                        <g id="SVGRepo_bgCarrier" stroke-width="0">
                            <rect
                                class="hover:fill-gray-400 transition duration-75"
                                x="-4.2"
                                y="-4.2"
                                width="29.40"
                                height="29.40"
                        ...
                        <g id="SVGRepo_iconCarrier">
                            ...
                            >
                                ...
                                <path d="m12.507 12.515 4-4-4-4.015"></path>
                                <path d="m6.507 12.515-4-4 4-4.015"></path>
                                <path d="m16.5 8.5h-14"></path>
                            </g>
                        </g>
                    </svg>
                </button>
            ...
            <div
                v-if="fullScaleImage"
                class="preview absolute inset-0 flex justify-center items-center bg-black bg-opacity-50 z-50"
            >
                <img
                    :src="fullScaleImage"
                ...
                <button
                    @click="toggleFullScaleImage"
                    class="absolute top-4 w-[64px] h-[64px]"
                >
                    <svg viewBox="-3.6 -3.6 31.20 31.20" fill="none">
                        <g id="SVGRepo_bgCarrier" stroke-width="0">
                            <rect
                                x="-3.6"
                                y="-3.6"
            ...
            <div class="relative">
                <input
                    ...
                    class="w-[250px] h-[35px] peer focus:outline-none border-2 border-black focus:border-sky-500"
                    placeholder=" "
                />
                <label
                    for="username"
                    class="absolute left-1 -top-6 peer-placeholder-shown:top-1 peer-focus:-top-6 transition-all duration-75"
                    >Username</label
                >
            </div>
            <!-- password input -->
            ...
            <div>
                <button
                    @click="onButtonClick()"
                    type="submit"
                    class="border border-black hover:bg-[#F0F0F0] w-[75px] h-[35px]"
                >
                    Submit
                </button>
            </div>
