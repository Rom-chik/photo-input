...
<template>
  <div class="flex justify-center items-center w-1/4 min-w-72 h-2/3 bg-[white]">
    <div class="flex flex-col gap-6 justify-center items-center">
      <h3 class="text-2xl">Fill out information</h3>
      <div></div>
      <div class="relative">
          <svg viewBox="0 0 24 24" fill="none" class="fill-gray-300 hover:fill-gray-400 w-[100px] h-[100px]">
            <rect width="24" height="24" rx="12"></rect>
            <path d="M5 21C5 17.134 8.134 14 12 14C15.866 14 19 17.134 19 21M16 7C16 9.209 14.209 11 12 11C9.791 11 8 9.209 8 7C8 4.791 9.791 3 12 3C14.209 3 16 4.791 16 7Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
          </svg>
          <svg fill="#000000" viewBox="-4.16 -4.16 40.32 40.32" preserveAspectRatio="xMidYMid" class="w-[32px] h-[32px] absolute left-8 top-20">
              <rect x="-4.16" y="-4.16" width="40.32" height="40.32" rx="20.16" fill="#b7b7b7" stroke-width="0" class="fill-gray-300 hover:fill-gray-400"></rect>
